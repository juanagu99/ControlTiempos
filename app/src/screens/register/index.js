     ...
     !PressSignIn ? (
       <View style={styles.container}>
         ...
         >
           ...
           <Text style={[styles.text_footer,{color: colors.text,marginTop: 35}]}>Confirmar contraseña</Text>
           ...
           <TouchableOpacity onPress={() => navigation.pop()}>
              <Text style={{color: '#000000', marginTop:5}} >Inicia sesión con tu cuenta.</Text>
          </TouchableOpacity>
           ...
           <TouchableOpacity onPress={() => navigation.navigate('Register')}
             ...
             <SocialButton buttonTitle="Registrate con Google"
                 btnType="google"
